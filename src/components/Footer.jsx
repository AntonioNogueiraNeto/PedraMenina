      ...
      <div className="mapa">
        <div className="div-esquerda">
          <div className="cardTextoFooter">
            <p>A mina está localizada no nordeste do Estado de Minas Gerais</p>

            <p>
              {" "}
              (Vale do Jequitinhonha), no município de Senador Modestino
              Gonçalves.
            </p>
            <p> A distância rodoviária de Belo Horizonte à mina é de 370 km.</p>
          </div>
